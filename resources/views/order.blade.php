...
<body>
    ...
    @endif
		<div class="form-group">
			...
			<input type="text" name="noidung" id="noidung" class="form-control" value="">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="number" name="sodt" id="sodt" class="form-control" value="" >
		</div>
      ...
      @else
      <div class="form-group">
        <a href="{{ route('dangnhap') }}"><button class="btn btn-primary">Mua</button></a>
      </div>
      @endif
	</form>
</div>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="first-row">{{$product['gia']}}VND </td>
							<td class="first-row">{{$product['soluong']}} </td>
							<td class="total-price first-row">
								<span >{{$cart->getPriceById($product['id'])}} VND</span>
							</td>
							
							<td class="close-td"><a style="color: black;" href="{{route('xoagiohang',($product['id']))}}"><button class="btn btn-primary">XÓA</button></a>
							</td>
							
							
						</tr>
						@endforeach
						<td class="close-td"><a style="color: black;" href="{{route('xoahetgiohang',($product['id']))}}"><button class="btn btn-primary">XÓA HẾT</button></a>
							</td>
							<td>Tổng tiền: {{number_format($cart->totalPrice)}} VND</td>
						@endif
